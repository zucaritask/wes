...
* Version 0.1.9 [1/5]
  - [ ] Move logic from wes_channel to ... something.
  - [ ] Rename wes channel state to #wes_channel{}
  - [ ] Write unit tests for wes_channel logic
  - [X] Write unit tests for wes_actor
  - [ ] Maybe move integration tests in wes_tests.erl to common tests.
...
* Version 0.2 [0/5]
  ...
  - [ ] Put actor locker timeout in actor config.
  - [ ] State migrations
