-module(wes_example_should_save).
...
key(Actorname) ->
    <<"example_should_save", (atom_to_binary(Actorname, utf8))/binary>>.

%% only store if counter is bigger than 5.
should_save(_Actorname, ActorState) ->
    ActorState > 5.
